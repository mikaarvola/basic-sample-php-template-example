...
{
	// On KeyUp set BirthPlace in variable and cookie
	$("[name='Q007']").keyup(function()
	{
		Q007 = $(this).val();
		$('#keyup').text(Q007);
		Cookies.set('Q007', Q007, { expires: config.cookietime, path: '' });
...
{
	// On KeyUp set BirthPlace in variable and cookie
	$("[name='Q008']").keyup(function()
	{
		Q008 = $(this).val();
		$('#keyup').text(Q008);
		Cookies.set('Q008', Q008, { expires: config.cookietime, path: '' });
